...
export default function HomePage() {
  return (
    <div>
        ...
        <div className="container relative mx-auto px-4 py-16 md:py-24">
          <div className="mx-auto max-w-3xl text-center">
            ...
            <p className="mt-6 text-lg text-gray-600 md:text-xl">
              ...
              Shop across hundreds of brands and enjoy <strong className="text-emerald-600">Jara</strong> —
        ...
        <div className="container mx-auto px-4">
          <div className="grid gap-8 md:grid-cols-3">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">See the Jara</h3>
                <p className="mt-1 text-sm text-gray-500">
            ...
            <div className="flex items-start gap-4">
              ...
              <div>
                <h3 className="font-semibold text-gray-900">Enjoy More</h3>
                <p className="mt-1 text-sm text-gray-500">
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="flex items-end justify-between">
            ...
            <Link
              href="/search"
              className="hidden items-center gap-1 text-sm font-medium text-emerald-600 hover:text-emerald-700 md:flex"
            >
              View all
          ...
          <div className="mt-8 grid grid-cols-2 gap-4 md:grid-cols-3 lg:grid-cols-6">
            {categories.map((category) => (
              <Link
                ...
                className="group flex flex-col items-center rounded-xl bg-white p-6 shadow-sm transition-all duration-200 hover:-translate-y-1 hover:shadow-md"
              >
      ...
      <section className="py-16">
        <div className="container mx-auto px-4">
          <div className="overflow-hidden rounded-2xl bg-gradient-to-r from-emerald-600 to-teal-600 p-8 md:p-12">
            <div className="flex flex-col items-center justify-between gap-8 md:flex-row">
              <div className="text-center md:text-left">
                ...
                <div className="mt-6 flex flex-wrap items-center justify-center gap-4 text-sm text-emerald-100 md:justify-start">
                  <span className="flex items-center gap-1">
              ...
              <Button
                size="lg"
                className="shrink-0 bg-white text-emerald-600 hover:bg-gray-100"
                asChild
              >
