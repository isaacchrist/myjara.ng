...
export default async function RetailerOrderDetailPage({ params }: { params: Promise<{ id: string }> }) {
    ...
    const { data: order, error } = await supabase
        ...
        `)
        .eq('id', id)
        .eq('store_id', activeStore.id) // Ensure order belongs to ACTIVE store
        .single() as any
                                            ...
                                            <div className="flex-1">
                                                ...
                                                <div className="mt-1 flex items-center gap-4 text-sm text-gray-500">
                                                    ...
                                                    {item.jara_quantity > 0 && (
                                                        <Badge variant="secondary" className="bg-emerald-100 text-emerald-700">+{item.jara_quantity} Jara</Badge>
                                                    )}
                                                </div>
                                            </div>
