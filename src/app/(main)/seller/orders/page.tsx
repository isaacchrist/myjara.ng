...
import { updateOrderFulfillmentStatus } from "@/app/(main)/(brand)/dashboard/orders/actions"
...
export default function RetailerOrdersPage() {
    ...
    // Use the context provided by SellerLayout
    ...
    return (
        <div className="space-y-6 p-8 max-w-7xl mx-auto">
            ...
            <div className="flex flex-col sm:flex-row gap-4">
                ...
                <select
                    className="h-10 w-full sm:w-48 rounded-md border border-gray-200 bg-white px-3 text-sm focus:outline-none focus:ring-2 focus:ring-emerald-500"
                    value={statusFilter}
