...
import { Loader2, Store, Phone, Mail, CheckCircle, XCircle, User, MapPin } from 'lucide-react'
                                    ...
                                    <div className="flex items-center gap-4">
                                        ...
                                        <div>
                                            ...
                                            <CardDescription className="flex flex-wrap items-center gap-2 mt-1">
                                                <Badge variant="outline" className="bg-blue-50 text-blue-700 border-blue-200 capitalise">
                                                    Retailer/Brand
                                                </Badge>
                                                {store.shop_type && (
